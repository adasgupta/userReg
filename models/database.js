...
client.connect();
var query = client.query("CREATE TABLE userInfo(id serial primary key ,firstname varchar(50),lastname varchar(50),email varchar(80),address varchar(200),cellphone bigint)");
